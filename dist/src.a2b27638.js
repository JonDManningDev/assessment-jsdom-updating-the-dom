...
function addHeadings(document) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var artHeading = document.createElement("h2");
...
function separateAllTutorials() {
  var tutsInSection = document.querySelector("section.articles > .tutorial");
  var newTutSection = document.createElement("section");
  newTutSection.classList.add("tutorials");
  var _iterator3 = _createForOfIteratorHelper(tutsInSection),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var tutorial = _step3.value;
    }
  } catch (err) {
    _iterator3.e(err);
  } finally {
